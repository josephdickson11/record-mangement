 ...
 */
public class ExpelstudentController implements Initializable {

    @FXML
    private JFXButton expelBtn;
    @FXML
    private JFXTextField maticNo;
    @FXML
    ...
    private void expelButton(ActionEvent event) {
        ...
        if (u.isEmpty()) {
            ...
            Mainproject.saveStudent.remove(u);
        } else {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText("Invalid Login");
    ...
    private void cancelButton(ActionEvent event) {
        ...
        try {
            ...
            Logger.getLogger(ExpelstudentController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
