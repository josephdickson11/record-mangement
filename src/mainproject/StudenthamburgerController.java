 ...
 */
public class StudenthamburgerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            VBox box = FXMLLoader.load(getClass().getResource("studentdrawerbox.fxml"));
            ...
            Logger.getLogger(StudenthamburgerController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void backBtn(ActionEvent event) {
        ...
        mainproject.Mainproject.loggedIn = null;
